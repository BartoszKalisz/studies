...
public class C_SCAN {
    ...
    public C_SCAN(ArrayList<zgloszenie> pomocnicza, ArrayList<Integer> wynikowa,int wielkosc) {
    ...
    public void oblicz()
    {
        ...
        {
            System.out.println("Moment przybycia :"+pomocnicza.get(i).moment_przybycia+"  Pozyjca:"+pomocnicza.get(i).pozycja);
        }
